...
#
# 2026-09-12 부터 evolve/* PR 은 CI 통과 시 자동 머지된다(.github/workflows/evolve-automerge.yml).
# 그래서 1번 분기(PR 방치)는 자동 머지가 막혔을 때만 걸리고, 평소의 주력은 3번 분기다 —
# 열린 PR 도 없는데 ledger 가 안 늘면 루틴 자체가 죽은 것이다.
#
